Careernest Data Science Internship – Project Submission

This repository contains the completed tasks for the 1-Month Data Science / Data Analyst Internship with Careernest Pvt. Ltd.
The internship focused on developing skills in data analysis, model building, and deriving business insights using real-world datasets.
